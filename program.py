...
def hit_or_stand(deck, hand):
	...
	while True:
		x = input('do you want to hit or stand? press h for hit s for stand')
		
		if x == 'h':
			hit(deck,hand)

		elif x == 's':
			print('Player stands and dealers turn now')
			playing = False
		
		

		else:
			print('enter h or s no more else')
			continue
